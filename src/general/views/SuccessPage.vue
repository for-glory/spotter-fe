  ...
  <div class="scrolled-page">
    ...
    <div v-else class="content">
      ...
      <div class="message-text">
        ...
        <div class="detail">
          <ion-text>
            Your 30 days trial is now active, you can cancel anytime before 30
            days, they will not be charged until the 30 days expire,
          </ion-text>
        </div>
      </div>
      <div class="buttons">
...
const {
  mutate: createStripeConnect,
  onDone: goToStripeConnect,
  loading: linkLoading,
} = useMutation(LinksDocument);

goToStripeConnect((res) => {
  if (res.data?.links.url) window.location.href = res.data.links.url;
});
</script>
