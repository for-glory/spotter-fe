      ...
      <ion-row class="detail-container">
        <ion-col size="12" size-lg="9">
          <div class="event-detail">
            <div>
              <img class="event-detail__img" :src="eventData?.media" />
              ...
              <div>
                <h4>Description:</h4>
                <ion-text>{{ eventData?.description || '' }}</ion-text>
...
import { IonText, IonSpinner, actionSheetController, IonRow, IonCol } from "@ionic/vue";
