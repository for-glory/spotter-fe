  ...
  <ion-menu content-id="landing-page">
    ...
    <ion-content class="ion-padding">
      <div class="landing-menu">
        <router-link to="/about-us" class="landing-menu__item">
          About us
        </router-link>
        <!-- <router-link
					to="/blog"
        ...
        <router-link to="/contact-us" class="landing-menu__item">
          Contact us
        </router-link>
        <router-link to="/terms-of-use" class="landing-menu__item">
          Terms of use
        </router-link>
        <router-link to="/how-it-works" class="landing-menu__item">
          How it works
        </router-link>
      </div>
    </ion-content>
    ...
    <div>
      <div class="first-part">
        ...
        <ion-grid :fixed="true">
          <ion-row class="embrace-section">
            <ion-col
              size="12"
              size-lg="7"
              class="embrace-section__content md-align-items-center"
            >
              <div class="embrace-section__content__first">
                <h1 class="lg-title md-text-center">
                  Find your spot, find your fit with
                  <ion-text color="primary">Spotter</ion-text>
                </h1>
                <ion-text class="detail-text">
                  Your journey to a healthier, happier you starts now. Take the
                  first step and let Spotter be your partner in reaching new
                  heights of wellness. Together we'll build a stronger fitter,
                ...
                <div class="get-buttons">
                  <ion-button class="get-button">
                    ...
                    <div class="d-flex flex-direction-column align-items-start">
                      <ion-text class="get-button__small-text"
                        >DOWNLOAD IT ON
                      </ion-text>
                ...
                <div
                  class="d-flex flex-direction-column align-items-center ion-padding-end ion-padding-vertical"
                >
                  <ion-text class="sm-title"
                    ><ion-text color="primary">Connect</ion-text> with hundreds
                    of top Trainers and world-class Gyms near you.</ion-text
                  >
                </div>
              </div>
              <div class="trainers">
                ...
                <div class="trainers__right">
                  <ion-text class="detail-text"
                    >Set your time. Set your pace. Maximize your
                    results.</ion-text
                  >
                </div>
              </div>
        ...
        <div class="for-sections">
          <ion-img
            class="my-location"
            src="assets/landing/my location small.png"
          />
              ...
              <div class="for-section__content find-content md-order-1">
                <div>
                  ...
                  <div class="for-section__content__detail">
                    <h1 class="md-title">
                      Find the nearest
                      <ion-text color="primary">Gym</ion-text> or
                      <ion-text color="primary">Trainer</ion-text> wherever you
                      are and wherever you go.
                    </h1>
                    <ion-text class="detail-text">
                      Never worry about backsliding; when you have a gym near
                      your home that feels like home, you'll always find
                      yourself in a space free from uncertainty and filled with
                      consistent success.
                    </ion-text>
                    <div>
                      <ion-text class="items-title"
                      ...
                      <ion-grid>
                        <ion-row>
                          <ion-col size="12" size-sm="4">
                            ...
                            <p>Become a member</p>
                            <p class="detail-text">
                              Tell us about yourself! Register and create your
                              profile in seconds.
                            </p>
                          </ion-col>
                          <ion-col size="12" size-sm="4">
                            ...
                            <p>Search</p>
                            <p class="detail-text">
                              Search & match with Gyms and Trainers wherever you
                              are.
                            </p>
                          </ion-col>
                          <ion-col size="12" size-sm="4">
                            ...
                            <p>Pay</p>
                            <p class="detail-text">
                              Securely book, pay, and communicate all in-app.
                              Get your sweat on and do it again!
                            </p>
                          </ion-col>
                        </ion-row>
                      </ion-grid>
            ...
            <ion-row class="for-section trainer-section">
              <div class="for-section__content trainers-content md-order-1">
                <div>
                  ...
                  <div class="for-section__content__detail">
                    <h1 class="md-title">
                      <ion-text color="primary">Increase visibility</ion-text>
                      gain exposure and
                      <ion-text color="primary">maximize </ion-text> your
                      earning potential.
                    </h1>
                    <ion-text class="detail-text">
                      Being a Spotter Trainer gives you access to our vast
                      network of clients looking for a trainer like you!
                    </ion-text>
                    <div>
                      ...
                      <ion-grid>
                        <ion-row>
                          <ion-col size="12" size-sm="4">
                            ...
                            <p>Flexibility</p>
                            <p class="detail-text">
                              Spotter gives you the freedom to create a schedule
                              that works for you!
                            </p>
                          </ion-col>
                          <ion-col size="12" size-sm="4">
                            ...
                            <p>Get Connected</p>
                            <p class="detail-text">
                              Safely and securely get matched and communicate
                              with ideal clients.
                            </p>
                          </ion-col>
                          <ion-col size="12" size-sm="4">
                            <ion-icon src="assets/icon/bike.svg" size="large" />
                            <p>Boost Earnings</p>
                            <p class="detail-text">
                              Offer your services in-person and/or digitally
                              anytime, anywhere with DAILYS and maximize your
                              earning potential.
                            </p>
                          </ion-col>
                        </ion-row>
          ...
          <ion-grid :fixed="true">
            <ion-row class="for-section gym-user-section">
              <div class="for-section__img md-order-2">
                <ion-img src="assets/landing/iPhone14-2.png" />
              </div>
              <div class="for-section__content gym-user-content md-order-1">
                <div>
                  ...
                  <div class="for-section__content__detail">
                    ...
                    <ion-text class="detail-text">
                      As a gym owner, showcase your facility, amenities, events,
                      and even trainers all in one convenient place. Spotter
                      makes it easy for anyone to find, visit, and make
                      purchases at your facility.
                    </ion-text>
                    <div>
                      <ion-text>Benefits include:</ion-text>
                      <ion-grid>
                        <ion-row>
                          <ion-col size="12" size-sm="4">
                            ...
                            <p>Visibility</p>
                            <p class="detail-text">
                              Exposure is key! Stand out from the rest, and let
                              Spotter help bring more eyes and traffic to your
                              facility
                            </p>
                          </ion-col>
                          <ion-col size="12" size-sm="4">
                            ...
                            <p>Connection</p>
                            <p class="detail-text">
                              "Attract, target, and retain more clients with
                              Spotter."
                            </p>
                          </ion-col>
                          <ion-col size="12" size-sm="4">
                            ...
                            <p>Amenities</p>
                            <p class="detail-text">
                              "Highlight your staff, amenities, offerings, and
                              create events easily and efficiently with
                              Spotter."
                            </p>
                          </ion-col>
                        </ion-row>
                        <ion-row>
                          <ion-col size="12" size-sm="4">
                            ...
                            <p>Tools & Features</p>
                            <p class="detail-text">
                              Dashboarding, analytics, and facility management.
            ...
            <ion-row class="for-section users-section">
              <div class="for-section__content users-content md-order-1">
                <div>
                  ...
                  <div class="for-section__content__detail">
                    <h1 class="md-title">
                      Gain <ion-text color="primary"> access</ion-text> to
                      hundreds of participating Gyms and Trainers wherever you
                      go.
                    </h1>
                    <ion-text class="detail-text">
                      As a registered Spotter User, you'll have access to any
                      Spotter Gym or Trainer in our network anywhere in the
                      world. Whether you're vacationing, on the go, new in town,
                      or traveling for work, fitness is always within reach.
                      Spotter takes care of the heavy lifting so you don't have
                      to.
                    </ion-text>
                    <div>
                      <ion-text>Benefits include:</ion-text>
                      <ion-grid>
                        <ion-row>
                          <ion-col size="12" size-sm="4">
                            ...
                            <p>Flexibility</p>
                            <p class="detail-text">
                              Find the closest Gym, Trainer, or Facility in our
                              network. We bring fitness right to your
                              fingertips.
                            </p>
                          </ion-col>
                          <ion-col size="12" size-sm="4">
                            ...
                            <p>Connect</p>
                            <p class="detail-text">
                              Book, pay, and safely communicate all in-app.
                              Spend less time researching and calling. We’ve got
                              you covered.
                            </p>
                          </ion-col>
                          <ion-col size="12" size-sm="4">
                            ...
                            <p>On the GO!</p>
                            <p class="detail-text">
                              Take your favorite Trainer or Gym with you
                              wherever you go. With Dailys, you can enjoy your
                              favorite Trainer or workout for the price of a cup
                              of coffee!
                            </p>
                          </ion-col>
                        </ion-row>
              ...
              <div class="for-section__img md-order-2">
                <ion-img src="assets/landing/iPhone14-3.png" />
              </div>
            </ion-row>
          </ion-grid>
        </div>
      ...
      <div>
        ...
        <div class="mt-3 find-map">
          ...
          <div class="page-tabs-container" v-if="activeTab && !isSearchOnFocus">
            <page-tabs
              :tabs="tabs"
              class="page-tabs"
              :value="activeTab"
      ...
      <div class="keep-up-section">
        <ion-grid :fixed="true">
          <ion-row>
            <ion-col size="12">
              <h1 class="xl-title">
                Keep a steady pulse on your fit with Spotter.
              </h1>
            </ion-col>
          </ion-row>
          <ion-row>
            <ion-col size="0" size-md="5"> </ion-col>
            <ion-col size="12" size-md="7" class="ion-padding-bottom">
              <ion-text class="sm-title ion-padding-bottom"
                >GYMS AND FACILITIES - The revolution of fitness is here! With
                Spotter, take control of your business your way! Attract new
                clientele, increase foot traffic, highlight your amenities, and
                keep them coming back for more. The Spotter app was designed
                with your business in mind. Whether big or small, single or with
                multiple locations, Spotter can highlight your facility,
                offerings, events, trainers, and more.</ion-text
              >
            </ion-col>
          </ion-row>
          <ion-row>
          ...
          <div class="mt-3 first-content">
            ...
            <div>
              <ion-button class="button-dark large-btn" type="button">
          ...
          <div class="mt-3 second-content">
            ...
            <div class="detail">
              <ion-text class="sm-title"
                >TRAINERS - Get matched with clientele specifically looking for
                someone like you! Whether this is a side hustle or your
                full-time job, whether you are just starting out or a seasoned
                trainer, Spotter can do the heavy lifting. With Spotter, you can
                progressively overload your schedule while having the freedom
                and flexibility to be you!</ion-text
              >
      ...
      <div class="life-back-section">
        <div>
          <div class="ion-text-center">
            <div class="lg-title">
              With Spotter, you can Spot, <br />Sweat,
              <ion-text color="primary"> Repeat</ion-text>
            </div>
          </div>
      ...
      <div class="faq-section">
        <div class="faq-box">
          <div class="d-flex justify-content-center">
            <ion-text class="md-title faq-box__title"
              >Frequently asked questions</ion-text
            >
          </div>
