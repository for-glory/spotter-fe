                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="upper_img" style="text-align: center;">
                                    <img src="assets/backgrounds/gym_detail.png" style="width:100%;">
                                </div>
                            </div>
                                ...
                                <div class="flx" style="display:flex;justify-content:space-between;padding: 0 12px;">
                                    <div class="inner_tab">
                                        <h4 style="color:white;">
                                            Summer Gym
                                        </h4><br><img src="assets/backgrounds/pin.png" style="width:20px;"><span
                                            style="color:white;font-weight: 100;padding:5px;font-size:12px;">Dallas, Street
                                            Light, 1</span>
                                    </div>
                                    <div class="inner_pic"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="inner_txt" style="padding:0 12px;">
                                    <p style="font-weight:100;color: #AFAFAF;font-size:14px;">Want your body to be healthy?
                                        Join our program with directions according to body’s goals. Increasing physical
                                        strength is the goal of strenght training.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="mid_cont2">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="inner_txt" style="padding:0 12px;">
                                    <h2 style="color:white;font-size:14px;margin-bottom:15px;">Equipment</h2>
                                    <div class="tabs_sec" style="display: flex;">
                                        <div class="tab_1">
                                            <img src="assets/backgrounds/flame.png" alt="drop" class="img-fluid"
                                                style="max-width: 15px;"><span
                                                style="color:#E1DBC5;padding:10px;font-size:12px">Gym Items</span>
                                        </div>
                                        <div class="tab_1" style="margin-left: 17px;">
                                            <img src="assets/backgrounds/Group 6.png" alt="burger" class="img-fluid"
                                                style="max-width: 16px;"><span
                                                style="color:#E1DBC5;padding:10px;font-size:12px">Cycling Items</span>
                                        </div>
                                    </div>
                                    <div class="tabs_sec" style="display: flex;">
                                        <div class="tab_1">
                                            <img src="assets/backgrounds/flame.png" alt="drop" class="img-fluid"
                                                style="max-width: 15px;"><span
                                                style="color:#E1DBC5;padding:10px;font-size:12px">Cardio Items</span>
                                        </div>
                                        <div class="tab_1" style="margin-left: 17px;">
                                            <img src="assets/backgrounds/Group 6.png" alt="burger" class="img-fluid"
                                                style="max-width: 16px;"><span
                                    ...
                                    <div class="tabs_sec" style="display: flex;">
                                        <div class="tab_1">
                                            <img src="assets/backgrounds/flame.png" alt="drop" class="img-fluid"
                                                style="max-width: 15px;"><span
                                                style="color:#E1DBC5;padding:10px;font-size:12px">Shower & Bath</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="inner_txt" style="padding:0 12px;">
                                    ...
                                    <div class="tabs_sec" style="display: flex;">
                                        <div class="tab_1">
                                            <img src="assets/backgrounds/flame.png" alt="drop" class="img-fluid"
                                                style="max-width: 15px;"><span
                                                style="color:#E1DBC5;padding:10px;font-size:12px">Drinks</span>
                                        </div>
                                        <div class="tab_1" style="margin-left: 17px;">
                                            <img src="assets/backgrounds/Group 6.png" alt="burger" class="img-fluid"
                                                style="max-width: 16px;"><span
                                                style="color:#E1DBC5;padding:10px;font-size:12px">Snack Bar</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="inner_txt" style="padding:0 12px;">
                                    <h2 style="color:white;font-size:14px;margin-bottom:15px;">Certifcations</h2>
                                    <div class="tabs_sec" style="display: flex;">
                                        <div class="tab_1">
                                            <img src="assets/backgrounds/flame.png" alt="drop" class="img-fluid"
                                                style="max-width: 15px;"><span
                                                style="color:#E1DBC5;padding:10px;font-size:12px">Advance Trainer ISSA2022</span>
                                        </div>
                                    </div>
                                    <div class="tabs_sec" style="display: flex;">
                                        <div class="tab_1">
                                            <img src="assets/backgrounds/flame.png" alt="drop" class="img-fluid"
                                                style="max-width: 15px;"><span
                                                style="color:#E1DBC5;padding:10px;font-size:12px">SEES 2018</span>
                                        </div>
                                        <div class="tab_1">
                                            <img src="assets/backgrounds/flame.png" alt="drop" class="img-fluid"
                                                style="max-width: 15px;"><span
                                                style="color:#E1DBC5;padding:10px;font-size:12px">RTEE COO 2015</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="inner_txt" style="padding:0 12px;">
                                    <h2 style="color:white;font-size:14px;margin-bottom:15px;">Waiver & Liabilities</h2>
                                    <div class="tabs_sec" style="display: flex;">
                                        <div class="tab_1">
                                            <img src="assets/backgrounds/flame.png" alt="drop" class="img-fluid"
                                                style="max-width: 15px;"><span
